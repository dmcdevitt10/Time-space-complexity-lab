...
// ANSWER: No, the code inside the for loop prevents it from iterating more than 4 times.
...
function getNumberSquared1(numbers){
  for(let i = 0; i < numbers.length; i++){
    numbers[i] *= numbers[i]
  }
  return numbers
...
// ANSWER: We could potentionally use up more space the bigger the sting is
